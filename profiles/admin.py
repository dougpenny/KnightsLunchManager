...
class ProfileAdmin(admin.ModelAdmin):
    fields =  ['user', 'current_balance', 'role', 'status', 'grade_level', 'school', 'room', 'phone', 'lunch_id', 'user_number', 'dcid', 'last_sync']
    list_display = ('last_first', 'role', 'lunch_id', 'current_balance')
    list_filter = ['role', 'status', 'school']
    inlines = [ProfileInline,]
    ordering = ['user__last_name']
    readonly_fields = ['grade_level', 'last_sync', 'lunch_id', 'phone', 'role', 'room', 'school', 'user_number', 'dcid']
