...
class ProfileAdmin(admin.ModelAdmin):
    ...
    def get_fields(self, request, obj=None):
        role_fields = {
            Profile.STAFF: ['user', 'current_balance', 'role', 'status', 'grade_level',
            'room', 'phone', 'lunch_id', 'user_number', 'user_dcid', 'last_sync'],
            Profile.STUDENT: ['user', 'current_balance', 'role', 'status', 'grade_level', 'school',
            'lunch_id', 'user_number', 'student_dcid', 'homeroom_teacher', 'last_sync'],
            Profile.GUARDIAN: ['user', 'role', 'status', 'user_dcid', 'children', 'last_sync']
        }
